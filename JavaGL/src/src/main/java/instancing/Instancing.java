...
public class Instancing extends JFrame implements GLEventListener
{	private GLCanvas myCanvas;
	...
	public static void main(String[] args) { new Instancing(); }
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		String vshaderSource[] = util.readShaderSource("src/src/main/java/instancing/vert.shader");
		String fshaderSource[] = util.readShaderSource("src/src/main/java/instancing/frag.shader");
