...
while True:
    try:
        print "Touch Sensor: " . BrickPi.Sensor[PORT_1]
        c = raw_input("Enter direction: ")
        print c;
        if c == '8' :
            print "Running Forward"
            BrickPi.MotorSpeed[PORT_B] = 210  #Set the speed of MotorA (-255 to 255)
            BrickPi.MotorSpeed[PORT_C] = 210  #Set the speed of MotorD (-255 to 255)
        elif c == '2' :
