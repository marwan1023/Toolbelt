...
public class QuitDialog extends Dialog
{
    ...
    public QuitDialog(Frame parent, boolean modal)
	{
		...
		add(yesButton);
		yesButton.setBackground(new java.awt.Color(0,0,128));
		//yesButton.setForeground(new java.awt.Color(253,236,219));
		yesButton.setFont(new Font("Dialog", Font.BOLD, 12));
		yesButton.setBounds(72,80,79,22);
		noButton.setLabel("  No  ");
		add(noButton);
		noButton.setBackground(new java.awt.Color(0,0,128));
		//noButton.setForeground(new java.awt.Color(253,236,219));
		...
		add(label1);
		label1.setForeground(new java.awt.Color(0,0,128));
		label1.setFont(new Font("Dialog", Font.BOLD, 12));
		label1.setBounds(78,33,180,23);
		setTitle("Exit JST- Stable Storage");
		//}}
	...
	public static void main(String[] args)
	{
	    ...
	    QuitDialog qd = new QuitDialog(frame, true);
	    qd.setVisible(true);
	}
}
