...
public class MergePhantom {

    private MergePhantom() {
    }

    public static void main(String[] args) {
        String sourceFilePath = "/Users/johnson_marcus/Dropbox/Apps/PiExperiment/phantomLogs";

        String fileType = "csv";
        String mergedFilePath = "/Users/johnson_marcus/Dropbox/Apps/PiExperiment/phantomLogs/merged/MergedPhantom.csv";
