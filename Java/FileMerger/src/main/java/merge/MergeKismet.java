...
public class MergeKismet {

    private MergeKismet() {
    }

    public static void main(String[] args) {
        String sourceFilePath = "/Users/johnson_marcus/Dropbox/Apps/PiExperiment/kismetArchive/CSV";

        String fileType = "csv";
        String mergedFilePath = "/Users/johnson_marcus/Dropbox/Apps/PiExperiment/kismetArchive/CSV/merged/MergedKismet.csv";
