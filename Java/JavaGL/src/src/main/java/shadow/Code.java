...
{	private GLCanvas myCanvas;
	...
	private String dir = "src/src/main/java/shadow/";
	
	
	// model stuff
	private ImportedModel pyramid = new ImportedModel(dir + "pyr.obj");
...
//-----------------
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		vBlinn1ShaderSource = util.readShaderSource(dir + "blinnVert1.shader");
		vBlinn2ShaderSource = util.readShaderSource(dir + "blinnVert2.shader");
		fBlinn2ShaderSource = util.readShaderSource(dir + "blinnFrag2.shader");
