...
public class Code extends JFrame implements GLEventListener
{
	...
	private String dir = "src/src/main/java/skybox/";
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		Texture t = loadTexture(dir + "brick1.jpg");
		textureID1 = t.getTextureObject();

		t = loadTexture(dir + "alien.jpg");
...
//-----------------
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		CvertShaderSource = util.readShaderSource(dir + "vert.shader");
		CfragShaderSource = util.readShaderSource(dir + "frag.shader");
