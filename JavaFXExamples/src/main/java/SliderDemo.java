...
public class SliderDemo extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        slider1.valueProperty().addListener((e) -> System.out.println(slider1.getValue() + " degrees C selected"));
        
        Slider slider2 = new Slider(-1.0, 1.0, 0.5);
        slider2.setMajorTickUnit(0.05);
        slider2.setShowTickLabels(false);
        slider2.setShowTickMarks(true);
        slider2.valueProperty().addListener((e) -> System.out.println(slider2.getValue()));
